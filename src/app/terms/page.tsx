  ...
  return (
    <div className="mx-auto w-full max-w-xl flex-1 px-6 py-14">
      ...
      <div className="rise rise-d1 mt-12 space-y-8 text-sm font-light leading-8 text-hanji-dim">
        ...
        <section>
          <h2 className="text-[15px] text-gold-soft">3. 기록의 보관과 책임</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-[15px] text-gold-soft">4. 콘텐츠와 저작권</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-[15px] text-gold-soft">6. 약관의 변경</h2>
          <p className="mt-3">
