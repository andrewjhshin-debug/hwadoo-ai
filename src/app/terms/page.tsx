    ...
    <div className="mx-auto w-full max-w-xl flex-1 px-6 py-14">
      ...
      <div className="rise rise-d1 mt-12 space-y-8 text-sm font-light leading-8 text-hanji-dim">
        ...
        <section>
          ...
          <p className="mt-3">
            서비스는 만 19세 이상만 이용할 수 있습니다. 인연 기능은 성인
            이용자 간 1:1 쪽지와 오프라인 동행(사찰 방문·법회 참석 등) 약속을
            포함하므로, 만 19세 미만은 이용할 수 없습니다.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3">
            다만 <span className="text-hanji">무상으로 지급된 연꽃</span>—
            첫 가입 선물, 공덕을 바꿔 받은 것, 이벤트·보상으로 드린 것—은
            이용자가 대가를 치르지 않은 것이므로 환불·현금화·양도의 대상이
            아닙니다. 유상으로 구매한 연꽃과 무상으로 받은 연꽃이 함께 있을
            때에는 <span className="text-hanji">무상분을 먼저 사용</span>한
            것으로 보고, 환불은 남은 유상분을 기준으로 셈합니다.
          </p>
          <p className="mt-3">
            공덕(功德)은 수행 기록일 뿐 재화가 아닙니다. 사고팔 수 없고,
            현금·포인트로 바꿀 수 없으며, 계정 사이에 옮길 수 없습니다.
            서비스가 끝나면 함께 사라집니다.
          </p>
        </section>
