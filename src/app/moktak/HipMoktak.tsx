...
export type HipMoktakProps = {
  ...
  keySrc: { cup: string; buddha: string; ar: number };
        ...
        <div className="hip-screen-mid">
          ...
          {/* ── 박자 ──
              ...
              **몇 번째로 고르게 치고 있는지**까지 적어 주면, 숫자가 올라가는
              ...
              목탁이 손 밑에서 움직인다. */}
          {/* 형: 「키캡도 눌렸을 때 합이 맞으면 목탁처럼 그 기능 넣어,
              계속 누르도록 유도하게」 — 치는 물건 둘(목탁·키캡)에만 둔다.
              염주는 굴리는 것이고 싱잉볼은 여운을 듣는 것이라 박자가 없다. */}
          {(tab === "moktak" || tab === "keycap") && (
          ...
          {/* 키캡 살갗 고르기는 없다 — 형: 「키캡도 동자만 둬라」
              「목탁 키캡도 지우고」. 그림 두 장도 지웠다. */}
