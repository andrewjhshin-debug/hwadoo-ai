          ...
          <div aria-hidden className="pointer-events-none absolute inset-0">
            ...
            {(() => {
              ...
              return Array.from({ length: RING_BEADS }, (_, i) => {
                ...
                //
                // 알은 뒤로 갈수록 **작아지는데 자리는 안 좁아졌다.**
                // 크기만 줄고 간격은 그대로니 뒤쪽에 틈이 벌어진다.
                // 진짜 고리는 멀수록 작아지면서 **가운데로 모인다** —
                // 그게 원근이다. 눈에서 고리까지를 반지름의 3.5배로 두고,
                // 멀기(cos)에 따라 크기와 자리를 **같은 수**로 줄인다.
                // 하나의 수로 줄이니 크기와 간격이 함께 좁아져 틈이 없다.
                // 폭 — 옆 알까지의 거리에서 나온다. 그런데 **그림에
                // 테두리가 있다**: bead-paw-one.png 는 920px 판에 알이
                // 802px 로 앉아 있어(양옆 59px 씩), 그린 폭의 **87%**만
