...
const 항목: { h: string; p: string[] }[] = [
  {
    ...
    p: [
      ...
      "가입 시 생년을 확인하며, 인연 기능을 이용하려면 휴대전화 본인확인을 거쳐야 합니다. 본인확인 결과 만 19세 미만으로 확인되면 해당 기능의 이용이 즉시 차단됩니다.",
    ],
  },
  {
    h: "2. 유해정보로부터의 보호",
    p: [
      "이용자가 올린 사진은 공개 전에 운영자가 확인합니다. 확인을 통과하지 못한 사진은 다른 이용자에게 노출되지 않습니다.",
