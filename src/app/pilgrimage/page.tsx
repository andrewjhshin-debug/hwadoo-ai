...
export default function PilgrimagePage() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-1 flex-col px-6 pb-16 pt-8 md:pt-12">
      ...
      <p className="rise rise-d2 mt-6 break-keep text-center text-[15px] leading-8 text-hanji-dim">
      ...
      <section className="rise rise-d3 mt-12">
        ...
        <div className="mt-4 border-t border-ink-3 pt-5">
          <p className="break-keep text-[15px] leading-8 text-hanji-dim">
          ...
          <div className="mt-4">
            <Link
              href="/gathering"
              className="inline-block rounded-[10px] border border-gold/50 px-6 py-3 text-[14px] tracking-[0.15em] text-gold transition-colors hover:bg-gold/10"
            >
              모임 보러 가기 →
            </Link>
          </div>
