...
// 뜰 — **연꽃만.** 금빛 한 색.
// 한 번은 만다라 테를 둘렀다가 물렀다. 형: 「그냥 그 안에 연꽃으로만
// 하라니까 바퀴나 동그라미 넣지 말고」. 테를 두르면 자리를 나눠 먹어
// 꽃이 작아진다. 꽃만 두면 그 자리를 다 쓴다.
// 연꽃 공양 자리의 그것과 **같은 꽃, 다른 빛깔**이다(금 / 분홍·초록).
