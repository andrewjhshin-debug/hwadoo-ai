...
const D: Record<string, Door> = {
  ...
  sutra: { href: "/sutra", label: "외우기", say: "입에 붙이다", Icon: Book },
  ...
  archive: { href: "/archive", label: "서고", say: "지나온 화두", Icon: Book },
...
const AFTER: Record<string, (keyof typeof D)[]> = {
  ...
  "/pilgrimage": ["gathering", "settings", "community"],
  "/gathering": ["pilgrimage", "community", "myHwadu"],
  "/community": ["gathering", "myHwadu", "masters"],
